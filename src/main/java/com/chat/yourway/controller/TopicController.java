...
public class TopicController {
  ...
  public TopicResponseDto createPrivate(
      @Valid @RequestBody TopicPrivateRequestDto topicRequestDto, Principal principal) {
    String email = principal.getName();
  ...
  public TopicResponseDto update(
      @PathVariable Integer id, @RequestBody TopicRequestDto topicRequestDto, Principal principal) {
    String email = principal.getName();
  ...
  @Operation(
      summary = "Delete by creator and topic id",
      responses = {

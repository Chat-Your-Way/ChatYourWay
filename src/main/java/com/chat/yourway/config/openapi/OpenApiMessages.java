...
public class OpenApiMessages {
  ...
  public static final String SUCCESSFULLY_ACTIVATED_ACCOUNT =
      "Contact account successfully activated";
  public static final String EMAIL_TOKEN_NOT_FOUND =
      "Email token for contact wasn't found in repository";
  public static final String SUCCESSFULLY_CHANGING_PASSWORD =
      "Contact successfully changing password";
  ...
  public static final String SUCCESSFULLY_RESTORED_PASSWORD =
  ...
  public static final String SUCCESSFULLY_SUBSCRIBED =
      "Contact successfully subscribed to the topic";
  ...
  public static final String SUCCESSFULLY_UNSUBSCRIBED =
      "Contact successfully unsubscribed from the topic";

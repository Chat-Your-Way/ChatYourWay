...
public interface ContactService {
    ...
    /**
     * Sends a password restoration email to the specified email address.
     * This method initiates the process of sending an email to the provided email address,
     ...
     *
     * This method allows a user to restore their password by providing a new password along
     * with the restoration token received through the password restoration process.
     *

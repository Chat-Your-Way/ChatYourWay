...
class NicknameValidationValidatorTest {
    ...
    @DisplayName("NicknameValidator should fail validator when user input nickname with invalid length")
    @Test
    ...
    @DisplayName("NicknameValidator should fail validator when user input nickname with invalid characters")
    @Test
